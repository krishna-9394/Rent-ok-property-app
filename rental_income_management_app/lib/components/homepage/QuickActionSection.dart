...
class QuickActionSection extends StatelessWidget {
  ...
  List<Widget> actionCards = [
    ...
    ActionCard(
        onTap: () {},
        action: "Receive \nPayment",
        image: "images/ic_rupee.png"),
    ActionCard(
        onTap: () {}, action: "Add \nLead", image: "images/ic_add_user.png"),
    ActionCard(
        onTap: () {},
        action: "Add \nExpense",
        image: "images/ic_add_expense.png"),
    ActionCard(
        onTap: () {}, action: "Add \nDues", image: "images/ic_add_dues.png"),
    ActionCard(
        onTap: () {},
        action: "Send \nAnnouncement",
        image: "images/ic_annouce.png"),
    ActionCard(
        onTap: () {},
        action: "Add Team \nTenant",
        image: "images/ic_add_team.png"),
    ActionCard(
        onTap: () {},
        action: "Add Dues \nPackage",
        image: "images/ic_add_dues.png"),
    ActionCard(
        onTap: () {},
        action: "Add Bank \nAccount",
        image: "images/ic_add_bank.png"),
    ActionCard(
    ...
    ActionCard(
        onTap: () {},
        action: "Update Food \nMenu",
        image: "images/ic_food_menu.png"),
    ActionCard(
        onTap: () {},
        action: "Agreement \nSettings",
        image: "images/ic_contract.png"),
  ];
